    ...
    <Grid mb={3} container spacing={2}>
      ...
      <Grid alignItems="center" s={12} md={8} item container>
        <Typography variant="body1" align="center" color="text.primary">
          ...
          live widgets of information, such as the time, date, weather. Makers
          most commonly use a RaspberryPi-powered monitor covered by a sheet of
          two-way glass to make a Magic Mirror. The construction of these
          mirrors combines an understanding of remote computing with the
